...
ApplicationWindow {
    ...
    visible: true
    onClosing: {
        Quickshell.execDetached(["notify-send", Translation.tr("Welcome app"), "Welcome to CrescentShell! Reopen anytime with Super+Shift+Alt+/. Settings: Super+I", "-a", "Shell"]);
        Qt.quit();
    }
    title: "CrescentShell — Welcome"
                ...
                ContentSection {
                    ...
                    Flow {
                        ...
                        RippleButtonWithIcon {
                            ...
                            onClicked: {
                                Qt.openUrlExternally("https://github.com/notcandy001/Moonveil/wiki");
                            }
                        }
                        RippleButtonWithIcon {
